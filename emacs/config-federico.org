...
(with-eval-after-load 'window-extras
  (setq window-extras-frame-split-width-threshold 600)
...
(with-eval-after-load 'tlon-babel
  ...
  (setq tlon-babel-split-repo nil)
  (tlon-babel-init)
...
(with-eval-after-load 'faces-extras
  ...
  (setq faces-extras-org-level-height 0.9)
  (setq faces-extras-org-block-height 1.0)
  (setq faces-extras-org-code-height 0.9)
  (setq faces-extras-org-date-height 0.8)
  (setq faces-extras-org-tag-height 0.8)
  (setq faces-extras-org-property-value-height 0.7)
  )
#+end_src
