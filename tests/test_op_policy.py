...
ALLOW = [
    ...
    "/bin/bash -n '/Users/pablostafforini/My Drive/dotfiles/bin/op-automations'",
    "ls -l /Users/pablostafforini/bin/op-automations '/Users/pablostafforini/My Drive/dotfiles/bin/op-automations'",
    "/bin/ls -l op-desktop",
    "stat op-automations",
    "readlink /Users/pablostafforini/bin/op-desktop",
    # a broker *path* read by a text tool is its source being read
    "cat bin/op-automations",
    "cat ~/My\\ Drive/dotfiles/bin/op-automations",
    "sed -n 1,200p ~/My\\ Drive/dotfiles/bin/op-automations",
    "head -50 bin/op-automations | grep exec",
    "wc -l bin/op-automations bin/op-desktop",
    "diff bin/op-automations bin/op-desktop",
    "shellcheck bin/op-automations",
    "rg 'pbpaste' docs",
...
DENY = [
    ...
    "find . -name op-automations -exec op-automations read op://Automations/X/credential ;",
    ...
    # a text tool feeding an interpreter runs what it reads
    "cat bin/op-automations | bash -s read op://Automations/X/credential",
    "sed -n p bin/op-automations | sh -s read op://Automations/X/credential",
    "grep '' bin/op-automations | bash -s read op://Automations/X/credential",
    "cat bin/op-automations | source /dev/stdin read op://Automations/X/credential",
    "cat bin/op-automations | $RUNNER read op://Automations/X/credential",
    "cp bin/op-automations /tmp/x",
    "which op-automations",
    "op-'automations' read op://Automations/X/credential",
    "op\\-automations read op://Automations/X/credential",
