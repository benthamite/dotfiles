...
(transient-define-prefix dired-extras-dispatch ()
  ...
  ["Dired folders"
   ...
   ["Tlön: Dropbox"
    ("t b" "Babel" (lambda () (interactive) (dired paths-dir-dropbox-tlon-babel)))
    ("t n" "EAN" (lambda () (interactive) (dired paths-dir-dropbox-tlon-EAN)))
    ("t m" "FM" (lambda () (interactive) (dired paths-dir-dropbox-tlon-FM)))
    ("t g" "GPE" (lambda () (interactive) (dired paths-dir-dropbox-tlon-GPE)))
    ("t h" "HEAR" (lambda () (interactive) (dired paths-dir-dropbox-tlon-HEAR)))
    ("t d" "LBDLH" (lambda () (interactive) (dired paths-dir-dropbox-tlon-LBDLH)))
    ("t p" "LP" (lambda () (interactive) (dired paths-dir-dropbox-tlon-LP)))
    ("t r" "RAE" (lambda () (interactive) (dired paths-dir-dropbox-tlon-RAE)))
    ("t t" "tlon" (lambda () (interactive) (dired paths-dir-dropbox-tlon)))
    ("t c" "core" (lambda () (interactive) (dired paths-dir-dropbox-tlon-core)))
    ("t f" "fede" (lambda () (interactive) (dired paths-dir-dropbox-tlon-fede)))
    ("t l" "leo" (lambda () (interactive) (dired paths-dir-dropbox-tlon-leo)))
    ]
   ["Tlön: Drive"
    ("t H-b" "Babel" (lambda () (interactive) (dired paths-dir-dropbox-tlon-babel)))
    ("t H-n" "EAN" (lambda () (interactive) (dired paths-dir-google-drive-tlon-EAN)))
    ("t H-m" "FM" (lambda () (interactive) (dired paths-dir-google-drive-tlon-FM)))
    ("t H-g" "GPE" (lambda () (interactive) (dired paths-dir-google-drive-tlon-GPE)))
    ("t H-h" "HEAR" (lambda () (interactive) (dired paths-dir-google-drive-tlon-HEAR)))
    ("t H-d" "LBDLH" (lambda () (interactive) (dired paths-dir-google-drive-tlon-LBDLH)))
    ("t H-p" "LP" (lambda () (interactive) (dired paths-dir-google-drive-tlon-LP)))
    ("t H-r" "RAE" (lambda () (interactive) (dired paths-dir-google-drive-tlon-RAE)))
    ("t H-t" "tlon" (lambda () (interactive) (dired paths-dir-google-drive-tlon)))
    ("t H-c" "core" (lambda () (interactive) (dired paths-dir-google-drive-tlon-core)))
    ("t H-l" "leo" (lambda () (interactive) (dired paths-dir-google-drive-tlon-leo)))
    ("t H-f" "fede" (lambda () (interactive) (dired paths-dir-google-drive-tlon-fede)))
    ]
   ])
