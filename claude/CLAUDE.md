...
- **Drafting in my voice:** before drafting anything I will send or publish as my own (email, Slack, comments, tweets), read `context/voice.md` and follow its procedure: match the private voice samples it points to, then run the `humanize` skill on the draft before showing it to me.
