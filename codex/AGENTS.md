...
- Write decision points in plain language. Before asking me to choose, state the concrete action, why it is needed, what it will and will not do, and what remains uncertain or future work. Avoid abstract labels when ordinary concrete words would be clearer.
