...
#+begin_src emacs-lisp :tangle (print tlon-init-file-late-init)
(setq elbab-todos-jobs-id "19FDA2D4-C33C-48DB-8C48-546816F095EB")
(setq elbab-todos-generic-id "3311BBC7-41EF-4FA5-AC91-627ECD0AAC29")
...
(
 ...
 (paths-dir-source . (file-name-concat (expand-file-name "~") "source/"))
 ...
 (paths-dir-personal-csl-styles . (file-name-concat paths-dir-personal-bibliography "styles/"))
 (paths-dir-personal-csl-locales . (file-name-concat paths-dir-personal-bibliography "locales/"))
 ...
 (paths-file-elbab . paths-file-tlon-tareas-leo)
