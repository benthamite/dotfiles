...
:END:
#+begin_src emacs-lisp
(setq gptel-extras-dir "/Users/cartago/Library/CloudStorage/Dropbox/tlon/leo/gptel")
#+end_src
...
(with-eval-after-load 'mu4e-extras
  (setq mu4e-extras-newsletters-folder "/NEWSLETTERS")
...
(
 ...
 (paths-dir-emacs-profiles . (expand-file-name "~/.config/emacs-profiles/"))
