...
** citar-extras
#+begin_src emacs-lisp :tangle (print tlon-init-file-late-init)
(with-eval-after-load 'citar-extras
  (cancel-function-timers 'citar-extras-update-bibliographies)
  (message "`citar-extras' late-init config loaded."))
#+end_src

** ebib-extras
#+begin_src emacs-lisp :tangle (print tlon-init-file-late-init)
(with-eval-after-load 'ebib-extras
  (cancel-function-timers 'ebib-extras-reload-all-databases)
  (message "`ebib-extras' late-init config loaded."))
#+end_src
...
(with-eval-after-load 'gptel
  ;; gptel config
  (setq gptel-extras-dir "/Users/fede/Dropbox/obsidian/gptel/")
...
(with-eval-after-load 'tlon-forg
  (setq tlon-forg-when-reconciling 'issue)
  (setq tlon-when-assignee-is-nil 'no-capture)
  (setq tlon-when-assignee-is-someone-else 'no-capture)
...
(add-hook
 ...
 (lambda ()
   ...
   (cancel-function-timers 'ebib-extras-reload-all-databases)
   (setq revert-without-query '(".*gptel-context.*"))
