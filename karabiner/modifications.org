...
[[/images/keyboard/b-mode-emacs.svg]]

[[/images/keyboard/b-mode-macos.svg]]
...
Hold =Z= for cursor movement. Outside Emacs, this provides arrow keys (=j=/=k=/=l=/=;=), page up/down (=y=/=h=), and home/end (=m=/=/=). In Emacs, the keys trigger custom navigation commands via the =A-C-s-= modifier prefix, enabling more granular movement (by paragraph, sentence, defun, etc.). The =##= prefix on some keys allows shift to be held for selection.
