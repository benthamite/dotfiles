...
(
 ...
 (path-file-urls-open-externally-default . (file-name-concat path-dir-dotemacs "etc/urls-default.txt"))
 (path-file-urls-open-externally-firefox . (file-name-concat path-dir-dotemacs "etc/urls-firefox.txt"))
 )
#+end_src
