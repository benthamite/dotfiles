...
The Corne default layer at a glance, with simlayer annotations:

#+begin_example
    apps:Q   W   E   R   T  |  mouse:Y   U   I   O  diacrit:P
         A   S   D  char:F   G  |       H  del:J  site:K   L  sym:;
     nav:Z   X   C  num:V  media:B  |       N  math:M  trsp:,  manip:.   /

         Esc     Enter    toggle-win | toggle-app  Space     Tab
        (Ctrl)  (Shift)  (Command)  | (Control)  (mod)    (Option)
#+end_example
