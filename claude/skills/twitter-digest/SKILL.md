...
3. **Full scoring** (Procedure B from twitter-vet): for each account that passes, call `~/.claude/skills/twitter/lib/twitterapi.sh tweets <username>`. Score 1-10 against the list's `description`.
