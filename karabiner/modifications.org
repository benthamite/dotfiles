...
- [[#introduction][Introduction]]
  - [[#write-note-on-my-keyboard-setup][Write note on my keyboard setup]]
...
I have 15 simlayers, each triggered by a different home-row or common key (see [[*Simlayers][simlayer definitions]]).
...
[[/images/keyboard/slash-mode.svg]]
