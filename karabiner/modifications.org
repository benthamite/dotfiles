...
The remaining simlayers (=F=, =M=, =P=, =Q=, =V=, =Y=, =;=) don't use Emacs modifier prefixes---they insert characters directly or control the mouse.
...
I have 14 simlayers, each triggered by a different home-row or common key.
