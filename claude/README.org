...
remain blocked. Once the requested model is verified, the helper restores that
buffer's blocked/waiting state and leaves the ordinary whole-stage resume guard
unchanged.
