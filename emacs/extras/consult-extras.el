...
(defun consult-extras-locate-home ()
  ...
  (interactive)
  (let ((consult-locate-args (concat "mdfind -onlyin " path-dir-user)))
    (consult-locate)))
...
(defun consult-extras-locate-file-home ()
  ...
  (interactive)
  (let ((consult-locate-args (concat "mdfind -name -onlyin " path-dir-user)))
    (consult-locate)))
