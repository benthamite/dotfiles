...
- [[#appendices][Appendices]]
  - [[#i--useful-links][I — Useful links]]
    ...
    - [[#meta][Meta]]
  - [[#ii--list-of-keys][II — List of keys]]
  - [[#iii--letter-frequencies][III — Letter frequencies]]
...
{:des "Emacs: spacebar → C- (held) | ⌘tab (alone)"
 :rules [
         [:!Cspacebar {:modi :A-H-M-s- :key :spacebar} :emacs] ; ps/switch-to-alternate-buffer
...
{:des "b-mode (media controls)"
 :rules [:b-mode
         ...
         [:e {:mkey {:y 4500}}]
         [:f {:mkey {:x 1500}}]
         [:g {:modi :⇧⌘⌥⌃ :key :g}] ; Rectangle, half right
         [:h {:modi :⇧⌘⌥⌃ :key :h}] ; Rectangle, center
         [:i [:km "Use Play to control Spotify not shitty Apple Music"]]
         [:j :volume_decrement]
         [:k :mute]
         [:l :fastforward]
         [:m {:modi :⇧⌘⌃ :key :0}] ; dictation
         [:n {:modi :⇧⌘⌃ :key :1}] ; read aloud
         [:o :rewind]
         [:q {:mkey {:x -4500}}]
         [:r {:mkey {:x 4500}}]
         [:s {:mkey {:y -1500}}]
...
#+begin_src clojure
{:des "l-mode (org headings)"
 :rules [:l-mode
         [:a {:modi :C-H-M-s- :key :a}]
         [:b {:modi :C-H-M-s- :key :b}]
         [:c {:modi :C-H-M-s- :key :c}]
         [:d {:modi :C-H-M-s- :key :d}]
         [:e {:modi :C-H-M-s- :key :e}]
         [:f {:modi :C-H-M-s- :key :f}]
         [:g {:modi :C-H-M-s- :key :g}]
         [:h {:modi :C-H-M-s- :key :h}]
         [:i {:modi :C-H-M-s- :key :i}]
         [:j {:modi :C-H-M-s- :key :j}]
         [:m {:modi :C-H-M-s- :key :m}]
         [:n {:modi :C-H-M-s- :key :n}]
         [:o {:modi :C-H-M-s- :key :o}]
         [:p {:modi :C-H-M-s- :key :p}]
         [:q {:modi :C-H-M-s- :key :q}]
         [:r {:modi :C-H-M-s- :key :r}]
         [:s {:modi :C-H-M-s- :key :s}]
         [:t {:modi :C-H-M-s- :key :t}]
         [:u {:modi :C-H-M-s- :key :u}]
         [:v {:modi :C-H-M-s- :key :v}]
         [:w {:modi :C-H-M-s- :key :w}]
         [:z {:modi :C-H-M-s- :key :z}]
         [:x {:modi :C-H-M-s- :key :x}]
         [:y {:modi :C-H-M-s- :key :y}]
         [:period {:modi :C-H-M-s- :key :period}]
         ]}
#+end_src

**** TODO [#5] Tweak ~l~ modifiers so that it doesn't trigger accidental key presses
:PROPERTIES:
:ID:       78762D11-60DE-4811-AF4B-23A50F4496EC
:END:
Maybe use in in conjunction with the right command?
...
*** p-mode
:PROPERTIES:
:ID:       30BAC8D5-5966-4786-8C82-38543AD0FF04
:END:
#+begin_src clojure
...
{:des "q-mode (apps)"
 :rules [:q-mode
         [:b [:km "Activate: qBitTorrent (b)"]]
         [:d [:km "Activate: Discord (d)"]]
         [:e [:km "Activate: Emacs (e)"]]
         [:f [:km "Activate: Firefox (f)"]]
         [:g [:km "Activate: Goldendict (g)"]]
         [:h [:km "Activate: Chrome (h)"]]
         [:i [:km "Activate: Anki (i)"]]
         [:k [:km "Activate: Keyboard Maestro (k)"]]
         [:l [:km "Activate: DeepL (l)"]]
         [:m [:km "Activate: Media Center (m)"]]
         [:o [:km "Activate: Zoom (o)"]]
         [:p [:km "Activate: Preview (p)"]]
         [:r [:km "Activate: Karabiner-Elements (r)"]]
         [:s [:km "Activate: Slack (s)"]]
         [:t [:km "Activate: Terminal (t)"]]
         [:u [:km "Activate: Revolut (u)"]]
         [:v [:km "Activate: mpv (v)"]]
         [:w [:km "Activate: HoudahSpot (w)"]]
         [:x [:km "Activate: Signal (x)"]]
         [:y [:km "Activate: Spotify (y)"]]
         ]}
#+end_src
...
{:des "z-mode (navigation)"
 :rules [:z-mode
         ...
         [:r :!WTQr :emacs]
         [:f [:!TCn :!TCh] :chrome] ; Google Docs next heading
         [:f :!WTQf]
         [:e :!WTQe :emacs]
...
{:des "semicolon (symbols)"
 :rules [:semicolon-mode
         ...
         ;; [:!Sd :!Ebackslash] ; not sure what these two lines do
         ;; [:#SRf :!SEbackslash]
         ]}
#+end_src
...
#+begin_src clojure
;; TODO: split into two sections (Emacs/Outside Emacs)
{:des "slash simlyaer → files (Emacs) | app-specific macros (outside Emacs)"
 :rules [:slash-mode
         ...
         [:y {:modi :H-M-s- :key :y}]
         [:z {:modi :H-M-s- :key :z}]
         [:period {:modi :H-M-s- :key :period}]
         [:comma {:modi :H-M-s- :key :comma}]
