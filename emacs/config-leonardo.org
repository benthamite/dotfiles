...
(
 ...
 (paths-dir-csl-styles . (file-name-concat paths-dir-dropbox "repos/babel/ref/styles/"))
 (paths-dir-csl-locales . (file-name-concat paths-dir-dropbox "repos/babel/ref/locales/"))
 (paths-dir-blog . "")
 (paths-dir-journal . "")
 (paths-dir-wiki . "")
