...
reuse the existing website downloader; metadata, explicit attachment and entry
...
existing entry with a new operation. No global input functions are rebound.
...
route similarly normalizes its public document identifier.
